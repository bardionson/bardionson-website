---
title: Presidential Portrait Trump
date: '2022-01-01'
---

# [Presidential Portrait 2017 - 2021](https://superrare.com/artwork-v2/presidential-portrait-2017---2021-25179)
...
The artists NFT rendering of the Donald Trump Presidential Portrait for 2017 - 2021, in the classic early NFT CryptoArt animated gif and GAN style. Created using DCGAN from Soumith Chintala and forked by Robbie Barrat. Glitched versions available on [Hic Et Nunc](https://www.hicetnunc.xyz/objkt/105116) and[ ](//bit.ly/mintbasePresident-------------------------------------md5)[Mintbase](http://bit.ly/mintbasePresident)[ ](//bit.ly/mintbasePresident-------------------------------------md5)[ ](//bit.ly/mintbasePresident-------------------------------------md5)[https://www.hicetnunc.xyz/objkt/105159](https://www.hicetnunc.xyz/objkt/105159)

[md5](//bit.ly/mintbasePresident-------------------------------------md5) checksum: 5f374a6ed38a8dc0957666749d346244

Generated from a machine learning model of 20,000 images of news footage using Art-DCGAN (RobbIe Barrat) & his [portrait](https://github.com/robbiebarrat/art-DCGAN) model.

Sold as an [NFT on SuperRar](https://superrare.com/artwork-v2/presidential-portrait-2017---2021-25179)[e](https://superrare.com/artwork-v2/sage-anomaly-redux-8596)

**digital art with Ai Tools**

**768 × 768** Px 2021

![](https://ipfs.io/ipfs/QmXuT1QKXUHRkdUXoTGuytdrEgFUxbdyGERA2CZETQy4rw)

![](https://ipfs.io/ipfs/QmVqZJuskN4vpX4T4sFd7TupcaAM3jTjgNG314BppNk9s1)

![](https://arweave.net/NsSrhIk_iMk8gSFhs7wFFlpaOmBPYSV7t4EVeNIsJO0)

### Artist notes:

I used this same training material for [Stark Naked Fraud](http://bardionson.com/artist-portfolio/stark-naked-fraud/) and [There Is Nothing Wrong](http://bardionson.com/artist-portfolio/there-is-nothing-wrong/). About 20,000 images of Trump were retrained into a model of historical portrait paintings at 128 x 128 px.  Robbie Barrat  provided the original model by posting it on Github he created with all of the portraits from [Wikiart.org](http://wikiart.org). Stark Naked was Trump merged with historic nude paintings but this one is Trump merged with historical portraits.
...
I found this series of images in my archives created while experimenting with art-DCGAN and trying to make a latent space walk with it. It is 12 images that I enhanced, enlarged and created a gif out of. I wanted it to look like my early work of 2018 like [Burning Off The Dross](https://ipfs.pixura.io/ipfs/QmVdB3ZgtLMbRaipp3egDnTLzSFdQTPCJVSrpC9z71G8UB/burning-off-the-dross.jpg) which came from this same model.

Technical: art-dcgan a project forked from [DCGAN.torch](https://github.com/soumith/dcgan.torch) by [Soumith Chintala](https://github.com/soumith)  I trained my own model training it by feeding it 20,000 images of trump. The original size of the images is 128 x 128 px and the output of the model was the same size. I enlarged with Gigapixels. I also generated three variants of the art called melting glitch. They were produced by running the gif through SoX a program that converted the images to sound and then back to a gif file.

### Exhibitions

This Presidential Portrait will appear in Outside Forces 2021 at [Art Enables](http://artenables.org/) in Washington DC in September 2021

![Output from Robbie Barrat's Portrait Model from [https://github.com/robbiebarrat/art-DCGAN](https://github.com/robbiebarrat/art-DCGAN)](https://raw.githubusercontent.com/robbiebarrat/art-DCGAN/master/images/portraitnet_waifu2x.png)
